# 纯 Vibe Coding：用 Claude Code + Floniks 做 AI 时代的游戏（一步步教程）
...
![纯 Vibe Coding 做 AI 时代的游戏](./img/vibe-coding-game-dev/cover.png)

上一篇《[AI 时代，应该有 AI 时代的游戏开发方式](../ai-era-game-dev.md)》讲了"为什么"。这一篇讲"怎么做"——把我们这套方式一步一步拆开，全部来自真实的 git 历史，**你能照着复现**。
...
![深夜画廊 · 三位证人选择界面](./img/vibe-coding-game-dev/trio.webp)
...
![三位证人立绘：平静表情](./img/vibe-coding-game-dev/portraits.webp)

*同一条管线保证角色一致性：底图定人，图生图派生表情。*

![深夜画廊 · "凝视者"惊悚场景](./img/vibe-coding-game-dev/scene.webp)
...
> 本文所有截图、立绘、语音、音乐均来自本项目真实的构建过程与 Floniks 生成管线。开源脚手架 `rust_bevy_lua_game`；素材平台 [Floniks](https://floniks.com)（MCP 端点 `api.floniks.com/api/v1/mcp`）；编排 Claude Code。
