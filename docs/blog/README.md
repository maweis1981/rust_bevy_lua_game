...
| 日期 | 标题 | 一句话 |
| --- | --- | --- |
| 2026-07-08 | [玩法说明 ·《星核熔炉》Starforge：一根手指，两条公式，把黑洞喂成超新星](./2026-07-08-starforge-how-to-play.md) | 玩家向规则说明：按住瞄准/松手入轨、同级聚变升级、`GM=GM₀(1+Σm/1400)` 耦合即难度；核心规则 + 数值表 + 连锁/双子星/彗星/每日/星尘 + 上手小抄 |
